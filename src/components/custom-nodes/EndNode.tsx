  ...
  return (
    <div
      style={{
        ...
        filter: selected ? 'drop-shadow(0 4px 12px rgba(255, 77, 79, 0.4))' : 'none'
      }}
    >
      <Card
        size="small"
        style={{
          ...
          backgroundColor: selected ? '#fff1f0' : '#fff1f0',
          display: 'flex',
          flexDirection: 'column',
          alignItems: 'center',
          justifyContent: 'center',
          boxShadow: selected ? '0 8px 24px rgba(255, 77, 79, 0.3)' : '0 2px 8px rgba(0, 0, 0, 0.1)',
          border: selected ? '3px solid #1890ff' : '2px solid #ff4d4f',
          cursor: 'grab',
          transition: 'all 0.3s ease'
        }}
